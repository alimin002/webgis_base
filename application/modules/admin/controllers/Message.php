...
class Message extends Admin_Controller {
	...
	{
		//parameter dalam method diisi nama tabel
		$crud = $this->generate_crud('message');
		$crud->columns('message_id', 'message_content', 'message_from', 'message_to');
	...
	public function create()
	{
		...
		if ($form->validate())
		{
			...
			//kode dibawah perlu dipelajari lagi bawaan dari githubnya
		...
		$this->mPageTitle = 'Create Message';
